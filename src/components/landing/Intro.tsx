        ...
        <section id="intro" className="w-full py-12 md:py-24 lg:py-32 bg-secondary">
            <div className="container px-4 md:px-6">
                ...
                <div className="grid gap-10 md:grid-cols-2 max-w-5xl mx-auto">
                    <Card className="bg-card/50 border-primary/20 text-center p-8 flex flex-col justify-center items-center space-y-4 animate-fade-in opacity-0 [animation-delay:200ms]">
                        <h3 className="text-2xl font-bold font-headline">{t('urbanDevelopment.title')}</h3>
                        <p className="text-foreground/80">
                            {t('urbanDevelopment.description')}
                        </p>
                    </Card>
                    <Card className="bg-card/50 border-primary/20 text-center p-8 flex flex-col justify-center items-center space-y-4 animate-fade-in opacity-0 [animation-delay:400ms]">
